...
const socialLinks = [
  { name: "X/Twitter", url: HOST.twitter, Icon: XIcon },
  { name: "Instagram", url: HOST.instagram, Icon: InstagramIcon },
  { name: "LinkedIn", url: HOST.linkedin, Icon: LinkedInIcon },
  { name: "Google Scholar", url: HOST.google_scholar, Icon: GoogleScholarIcon },
];
    ...
    <section aria-labelledby="host-heading">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <nav aria-label="Host social links" className="flex gap-2">
            {socialLinks.map((link) => (
              <a
                ...
                className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-foreground/10 hover:bg-accent/20 text-foreground/70 hover:text-accent transition-colors"
